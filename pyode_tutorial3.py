...
device = createDevice(driverType, window_size, 16, False, False, False)#, i_event_receiver)

if device:
	device.setWindowCaption('testode')
	...
	camera = scene_manager.addCameraSceneNodeMaya()
	camera.setTarget(vector3df(0,20,0))
