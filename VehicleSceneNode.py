...
if device:
	...
	#wheels = [WheelSceneNode(base, scene_manager), WheelSceneNode(base, scene_manager), WheelSceneNode(base, scene_manager), WheelSceneNode(base, scene_manager)]
	wheels = [WheelSceneNode(base, scene_manager) for i in range(4)]
