...
IRRLICHT_C_API void line3df_delete(line3df* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API void line3di_delete(line3di* pointer){if(pointer)delete pointer;}
