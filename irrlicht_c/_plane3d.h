...
IRRLICHT_C_API void plane3df_delete(plane3df* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API const vector3df& plane3df_get_Normal(plane3df* pointer){return pointer->Normal;}
...
IRRLICHT_C_API void plane3di_delete(plane3di* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API const vector3di& plane3di_get_Normal(plane3di* pointer){return pointer->Normal;}
