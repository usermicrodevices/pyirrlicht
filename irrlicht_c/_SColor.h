...
IRRLICHT_C_API void SColor_delete(SColor* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API void SColorf_delete(SColorf* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API void SColorHSL_delete(SColorHSL* pointer){if(pointer)delete pointer;}
