...
IRRLICHT_C_API void listIGUIElementIterator_delete(list<IGUIElement>::Iterator* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API void listIGUIElement_delete(list<IGUIElement>* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API void IGUIElement_delete(IGUIElement* pointer){if(pointer)delete pointer;}
