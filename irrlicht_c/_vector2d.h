...
IRRLICHT_C_API void vector2df_delete(vector2df* pointer){if(pointer)delete pointer;}
// operators
...
IRRLICHT_C_API void vector2di_delete(vector2di* pointer){if(pointer)delete pointer;}
// operators
