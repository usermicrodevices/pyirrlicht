...
IRRLICHT_C_API void SMD3AnimationInfo_delete(SMD3AnimationInfo* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3Header_delete(SMD3Header* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3MeshHeader_delete(SMD3MeshHeader* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3Vertex_delete(SMD3Vertex* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3TexCoord_delete(SMD3TexCoord* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3Face_delete(SMD3Face* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3MeshBuffer_delete(SMD3MeshBuffer* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3QuaternionTag_delete(SMD3QuaternionTag* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3QuaternionTagList_delete(SMD3QuaternionTagList* pointer){if(pointer)delete[] pointer;}
...
IRRLICHT_C_API void SMD3Mesh_delete(SMD3Mesh* pointer){if(pointer)delete[] pointer;}
