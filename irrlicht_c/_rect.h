...
IRRLICHT_C_API void rectf_delete(rectf* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API const position2df& rectf_get_LowerRightCorner(rectf* pointer){return pointer->LowerRightCorner;}
...
IRRLICHT_C_API void recti_delete(recti* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API const position2di& recti_get_LowerRightCorner(recti* pointer){return pointer->LowerRightCorner;}
...
IRRLICHT_C_API void rects32array_delete(core::array< rect<s32> >* pointer){if(pointer)delete pointer;}
...
IRRLICHT_C_API const rect<s32>& rects32array_get_item(core::array< rect<s32> >* pointer, u32 index){return pointer->operator[](index);}
