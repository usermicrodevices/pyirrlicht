...
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixPerspectiveFovRH(matrix4* pointer, f32 fieldOfViewRadians, f32 aspectRatio, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixPerspectiveFovRH(fieldOfViewRadians, aspectRatio, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixPerspectiveFovLH(matrix4* pointer, f32 fieldOfViewRadians, f32 aspectRatio, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixPerspectiveFovLH(fieldOfViewRadians, aspectRatio, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixPerspectiveRH(matrix4* pointer, f32 widthOfViewVolume, f32 heightOfViewVolume, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixPerspectiveRH(widthOfViewVolume, heightOfViewVolume, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixPerspectiveLH(matrix4* pointer, f32 widthOfViewVolume, f32 heightOfViewVolume, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixPerspectiveLH(widthOfViewVolume, heightOfViewVolume, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixOrthoLH(matrix4* pointer, f32 widthOfViewVolume, f32 heightOfViewVolume, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixOrthoLH(widthOfViewVolume, heightOfViewVolume, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildProjectionMatrixOrthoRH(matrix4* pointer, f32 widthOfViewVolume, f32 heightOfViewVolume, f32 zNear, f32 zFar){return pointer->buildProjectionMatrixOrthoRH(widthOfViewVolume, heightOfViewVolume, zNear, zFar);}
IRRLICHT_C_API const matrix4& matrix4_buildCameraLookAtMatrixLH(matrix4* pointer, const vector3df* position, const vector3df* target, const vector3df* upVector){return pointer->buildCameraLookAtMatrixLH(*position, *target, *upVector);}
IRRLICHT_C_API const matrix4& matrix4_buildCameraLookAtMatrixRH(matrix4* pointer, const vector3df* position, const vector3df* target, const vector3df* upVector){return pointer->buildCameraLookAtMatrixRH(*position, *target, *upVector);}
...
IRRLICHT_C_API const matrix4& matrix4_buildTextureTransform(matrix4* pointer, f32 rotateRad, const vector2df* rotatecenter, const vector2df* translate, const vector2df* scale){return pointer->buildTextureTransform(rotateRad, *rotatecenter, *translate, *scale);}
IRRLICHT_C_API const matrix4& matrix4_setTextureRotationCenter(matrix4* pointer, f32 radAngle){return pointer->setTextureRotationCenter(radAngle);}
IRRLICHT_C_API const matrix4& matrix4_setTextureTranslate(matrix4* pointer, f32 x, f32 y){return pointer->setTextureTranslate(x, y);}
IRRLICHT_C_API const matrix4& matrix4_setTextureTranslateTransposed(matrix4* pointer, f32 x, f32 y){return pointer->setTextureTranslateTransposed(x, y);}
IRRLICHT_C_API const matrix4& matrix4_setTextureScale(matrix4* pointer, f32 sx, f32 sy){return pointer->setTextureScale(sx, sy);}
IRRLICHT_C_API const matrix4& matrix4_setTextureScaleCenter(matrix4* pointer, f32 sx, f32 sy){return pointer->setTextureScaleCenter(sx, sy);}
IRRLICHT_C_API const matrix4& matrix4_setM(matrix4* pointer, const f32* data)
{
