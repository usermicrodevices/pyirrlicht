...
@%1 Randomizer_ttfont.py 1> log_stdout_Randomizer_ttfont.txt 2> log_stderr_Randomizer_ttfont.txt

@%1 Meshviewer.py 1> log_stdout_Meshviewer.txt 2> log_stderr_Meshviewer.txt

@%1 Quake3Explorer.py 1> log_stdout_Quake3Explorer.txt 2> log_stderr_Quake3Explorer.txt
